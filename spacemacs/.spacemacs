...
you should place your code here."
  ...
  (setq jabber-alert-presence-hooks nil
        ...
        jabber-history-dir "~/.emacs.d/private/local/jabber-history"  ; Set history directory
        jabber-avatar-cache-directory "~/.emacs.d/private/local/jabber-avatar-cache"  ; Set avatar cache directory
        jabber-activity-count-in-title t
        fsm-debug nil                                  ; No debug messages
        undo-outer-limit 9990000)                      ; bh jabber tends bombard undo capacity in the roster buffer
